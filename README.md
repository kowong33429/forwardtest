...
2. **AI 1.2: Strategy Optimizer (ผู้จัดการกองทุน)**
   - **หน้าที่:** ไม่ได้ทำงานตลอดเวลา แต่มันจะถูกปลุกขึ้นมาทำงานตอน **23:59 น. ของทุกวันอาทิตย์ (โซนเวลาอเมริกา)**
   - มันจะกางประวัติออเดอร์ของทั้งสัปดาห์ขึ้นมาดู เพื่อหา **"จุดบอดร่วมกัน"** (เช่น สัปดาห์นี้ขาดทุนเพราะตั้ง Stop loss แคบไปช่วงข่าวแรง) และมันจะวิเคราะห์ว่าควรปรับแผน (Tune Parameter) หรือไม่
...
- **Dedicated AI Reports:** แยกหน้าสรุปผลของ AI 1.2 (Weekly Optimizer) ออกมาเป็นหน้าเฉพาะตัวเพื่อไม่ให้รกหน้า History
...
- `GET /optimization/{portfolio_id}` - ดึงรายงานสรุปผลการวิเคราะห์พอร์ตราายสัปดาห์จาก **AI 1.2 (Weekly Optimizer)**

**[Manual Triggers]**
- `POST /engine/tick` - สั่งบังคับให้บอทเริ่มเช็คราคาและเทรดทันที 1 รอบ (ใช้สำหรับทดสอบ)
- `POST /engine/optimize_now` - สั่งบังคับให้ AI 1.2 เริ่มวิเคราะห์พอร์ตและสรุปรายงานรายสัปดาห์ทันที (ไม่ต้องรอวันอาทิตย์ 23:59)
